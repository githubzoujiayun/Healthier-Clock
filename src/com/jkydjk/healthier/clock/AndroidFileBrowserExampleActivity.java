...
public class AndroidFileBrowserExampleActivity extends Activity {
	...
	// Arbitrary constant to discriminate against values returned to
	// onActivityResult
	// as requestCode
	@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		startBrowserButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Intent fileExploreIntent = new Intent(FileBrowserActivity.INTENT_ACTION_SELECT_DIR, null, activityForButton, FileBrowserActivity.class);
				// If the parameter below is not provided the Activity will try
				// to start from sdcard(external storage),
		...
		startBrowser4FileButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Intent fileExploreIntent = new Intent(FileBrowserActivity.INTENT_ACTION_SELECT_FILE, null, activityForButton, FileBrowserActivity.class);
				// fileExploreIntent.putExtra(
				// FileBrowserActivity.startDirectoryParameter,
				// "/sdcard"
				// );
		...
		final Button start4FileHideNonReadButton = (Button) findViewById(R.id.startBrowse4FileHideNonReadButtonID);
		...
		});// start4FileHideNonReadButton.setOnClickListener(new
