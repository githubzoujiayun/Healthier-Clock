...
public class AlarmClock extends BaseActivity implements OnClickListener {
  ...
  private void setWelcomeText() {
    ...
    if (5 <= hour && hour < 11) {
      welcomeTextView.setText(R.string.welcome_good_morning);
    } else if (11 <= hour && hour < 13) {
      welcomeTextView.setText(R.string.welcome_good_noon);
    } else if (13 <= hour && hour < 19) {
      welcomeTextView.setText(R.string.welcome_good_afternoon);
    } else {
      welcomeTextView.setText(R.string.welcome_good_evening);
    }
