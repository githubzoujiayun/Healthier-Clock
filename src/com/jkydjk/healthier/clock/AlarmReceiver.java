...
public class AlarmReceiver extends BroadcastReceiver {
  ...
  /**
   * If the alarm is older than STALE_WINDOW seconds, ignore. It is probably the
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    /*
     * launch UI, explicitly stating that this is not due to user action so that
     * the current app's notification management is not disturbed
     */
